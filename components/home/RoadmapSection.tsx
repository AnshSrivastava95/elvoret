...
export default function RoadmapSection() {
  return (
    <section className="relative left-1/2 mt-20 w-[calc(100vw-2rem)] -translate-x-1/2 rounded-3xl bg-purple-50 py-16 sm:mt-24 sm:w-[calc(100vw-3rem)] sm:py-20 lg:mt-28 lg:w-[calc(100vw-18rem)] lg:py-24">
